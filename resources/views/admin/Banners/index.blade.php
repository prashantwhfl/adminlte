									...
									<div>
										<div class="row mb-6">
											...
											<div class="col-lg-3 mb-lg-5 mb-6">
												...
												{{ Form::text('title',((isset($searchVariable['title'])) ? $searchVariable['title'] : ''), ['class' => ' form-control','placeholder'=>trans("Title")]) }}
											</div>

										<!--	<div class="col-lg-3 mb-lg-5 mb-6">
												<label>{{ trans("Link") }}</label>
												{{ Form::text('link',((isset($searchVariable['value'])) ? $searchVariable['value'] : ''), ['class' => ' form-control','placeholder'=>trans("Link")]) }}
											</div> -->
										...
										<thead>
											<tr class="text-uppercase">
												...
												<th class="{{(($sortBy == 'description' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'description' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
 												...
 												<th class="{{(($sortBy == 'link' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'link' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													{{
														link_to_route(
															"$sectionName.index",
															trans("Link"),
															array(
															'sortBy' => 'link',
															'order' => ($sortBy == 'link' && $order == 'desc') ? 'asc' : 'desc',
															$query_string
															)
														)
													}}
											...
											@if(!$results->isEmpty())
												@foreach($results as $result)
													<tr>
														...
														<td>
															<div class="text-dark-75 mb-1 font-size-lg">
																<img src="{{ BANNER_IMAGE_URL.$result->image }}" height="50px" width="100px;" >
															</div>
														</td>
														--}}
