									...
									<div class="col-xl-4">
										...
										<div class="form-group">
										   {!! HTML::decode( Form::label('image', trans("Image").'<span class="text-danger"></span>')) !!}
											...
											@if($model->image != "")	
												<br />
												<a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo CERTIFICATE_IMAGE_URL.$model->image; ?>"><img height="100" width="100" src="<?php echo CERTIFICATE_IMAGE_URL.$model->image; ?>" /></a>
											@endif		
										</div>
										<!--end::Input-->
									</div>
