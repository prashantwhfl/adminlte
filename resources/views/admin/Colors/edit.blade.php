							...
							<div class="col-xl-12">	
								<div class="row">
									...
									<div class="col-xl-6">
										<!--begin::Input-->
										<div class="form-group">
										    {!! HTML::decode( Form::label('color',trans("color").'<span class="text-danger"> * </span>')) !!}
											{{ Form::color("color",$model->value, ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('color') ? 'is-invalid':'')]) }}
												<div class="invalid-feedback"><?php echo $errors->first('color') ; ?></div>		
										</div>
										<!--end::Input-->
									</div>
								</div>
