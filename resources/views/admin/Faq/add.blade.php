								...
								<div class="row">
									<div class="col-xl-12">
										...
										<div class="form-group">
										    {!! HTML::decode( Form::label('name',trans("Question").'<span class="text-danger"> * </span>')) !!}
											{{ Form::text("question",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('question') ? 'is-invalid':'')]) }}
									...
									<div class="col-xl-12">
										<!--begin::Input-->
										<div class="form-group">
										     	{!! HTML::decode( Form::label('comment',trans("Answer").'<span class="text-danger">*</span>')) !!}
												{{ Form::textarea("answer",'', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('answer') ? 'is-invalid':''),'id' => '']) }}
