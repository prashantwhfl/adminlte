								...
								<div class="row">
									<div class="col-xl-12">
										...
										<div class="form-group">
										    {!! HTML::decode( Form::label('question',trans("Question").'<span class="text-danger"> * </span>')) !!}
											{{ Form::text("question",$model->question, ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('question') ? 'is-invalid':'')]) }}
												<div class="invalid-feedback"><?php echo $errors->first('question') ; ?></div>		
										</div>
										<!--end::Input-->
									</div>
									<div class="col-xl-12">
										<!--begin::Input-->
										<div class="form-group">
										     	{!! HTML::decode( Form::label('answer',trans("Answer").'<span class="text-danger">*</span>')) !!}
												{{ Form::textarea("answer",$model->answer, ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('answer') ? 'is-invalid':''),'id' => '']) }}
											<div class="invalid-feedback"><?php echo $errors->first('answer'); ?></div>
