								...
								<div class="row">
									...
									<div class="col-xl-4">
										...
										<div class="form-group">
											...
											{{ Form::text("location",$model->location, ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('location') ? 'is-invalid':'')]) }}
									...
									<div class="col-xl-4">
										...
										<div class="form-group">
											...
											{{ Form::text("rating",$model->rating, ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('rating') ? 'is-invalid':'')]) }}
									...
									<div class="col-xl-4">
										...
										<div class="form-group">
										   {!! HTML::decode( Form::label('image', trans("Image").'<span class="text-danger"></span>')) !!}
											...
											@if($model->image != "")	
												<br />
												<a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo REVIEW_IMAGE_URL.$model->image; ?>"><img height="50" width="50" src="<?php echo REVIEW_IMAGE_URL.$model->image; ?>" /></a>
											@endif		
										</div>
										<!--end::Input-->
									</div>
									<div class="col-xl-8">
										...
										<div class="form-group">
												...
												{{ Form::textarea("comment",$model->comment, ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('comment') ? 'is-invalid':''),'id' => '']) }}
