            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-10">
                            <h3 class="mb-10 font-weight-bold text-dark"> {{ $sectionNameSingular }} Information</h3>
                            ...
                            <div class="row">
								...
								<div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        {!! HTML::decode( Form::label('image', trans("Image").'<span
                                            class="text-danger"> </span>')) !!}
                                        {{ Form::file('image', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('image') ? 'is-invalid':''),'accept'=>'image/*']) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('mini_description','', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('mini_description') ? 'is-invalid':''),'id' => 'mini_description','rows'=>'1']) }}
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="switchcls">
                                          <input type="checkbox" checked name="sub_cat_status">
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('full_description','', ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('full_description') ? 'is-invalid':''),'id' => 'full_description','rows'=>'8']) }}
