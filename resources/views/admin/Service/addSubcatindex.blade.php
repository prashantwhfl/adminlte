...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul
						...
						<li class="breadcrumb-item">
							<a href='{{ route("$modelName.index")}}' class="text-muted">Category</a>
						</li>
						<!-- <li class="breadcrumb-item">
						<a href='{{ route("$modelName.subCatListing","$cat->id")}}' class="text-muted">SubCategory</a>
						</li> -->
					</ul>
					<!--end::Breadcrumb-->
				</div>
	...
	<div class="d-flex flex-column-fluid">
		...
		<div class=" container ">
			{{ Form::open(['method' => 'get','role' => 'form','url'=>route($modelName.'.subCatListing',$cat->id),'class' => 'kt-form kt-form--fit mb-0','autocomplete'=>"off"]) }}
			{{ Form::hidden('display') }}
			<div class="row">
				<div class="col-12">
	...
	<a href='{{route("$modelName.addSubCat", "$cat->id")}}'  class="btn btn-primary"> {{ trans("Add New ") }}SubCategory </a>
							</div>
						</div>
						<div class="card-body">
									...
									<div>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													...
													<a href='{{route("$modelName.subCatListing","$cat->id")}}'  class="btn btn-secondary btn-secondary--icon">
														<span>
									...
									@if(!$results->isEmpty())
												@foreach($results as $result)
													<tr>
														...
														@if($result->is_active == 1)
																<a  title="Click To Deactivate" href='{{route("$modelName.SubCatstatus",array($result->id))}}' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top"
															...
															@else
																<a title="Click To Activate" href='{{route("$modelName.SubCatstatus",array($result->id))}}' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top"
																data-container="body" data-boundary="window"
														...
														<a href='{{route("$modelName.editSubCat","$result->id")}}'
															...
															<a href='{{route("$modelName.deleteSubCat","$result->id")}}'
