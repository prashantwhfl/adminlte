					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								<a href="javascript:void(0);" class="btn btn-custombtncss dropdown-toggle mr-2"
									data-toggle="collapse" data-target="#collapseOne6">
									Search
								</a>
								
								<a href='{{route("$modelName.add")}}'  class="btn btn-custombtncss"> {{ trans("Add New ") }}{{ $sectionNameSingular }} </a>
							</div>
						</div>
						<div class="card-body">
							<div class="accordion accordion-solid accordion-toggle-plus"
								...
								<div id="collapseOne6" class="collapse <?php echo !empty($searchVariable) ? 'show' : ''; ?>" data-parent="#accordionExample6">
									<div>
											...
											<div class="row mt-8">
												<div class="col-lg-12">
													<button class="btn btn-custombtncss btn-success--icon"
														id="kt_search">
														<span>
												...
												@foreach($results as $result)
													<tr>
														<td>
															<div class="text-dark-75 mb-1 font-size-lg">   
																...
																<a class="fancybox-buttons" data-fancybox-group="button" href="{{$result->image}}">
																	<img class="" src="{{$result->image}}" width="50px" height="50px" style="background: #dadada;">
																</a>
																@else
														...
														<td class="text-right pr-2">
															@if($result->status == 1)
																<a  title="Click To Deactivate" href='{{route("$modelName.status",array($result->id))}}' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top"data-container="body" data-boundary="window"data-original-title="Deactivate">
															...
															@else
																<a title="Click To Activate" href='{{route("$modelName.status",array($result->id))}}' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top"data-container="body" data-boundary="window"data-original-title="Activate">
