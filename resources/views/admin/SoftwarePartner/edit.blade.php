							...
							<div class="col-xl-12">	
								<div class="row">
									...
									<div class="col-xl-4">
										<!--begin::Input-->
										<div class="form-group">
										   {!! HTML::decode( Form::label('type', trans("Type").'<span class="text-danger">*</span>')) !!}
										   {{ Form::select('type',array('software'=>'Software','bottom'=>'Bottom'),$model->type, ['class' => 'form-control form-control-lg'.($errors->has('type') ? 'is-invalid':'')]) }}
											<div class="invalid-feedback"><?php echo $errors->first('type'); ?></div>
										</div>
										<!--end::Input-->
									</div>
									...
									<div class="col-xl-4">
										...
										<div class="form-group">
										   {!! HTML::decode( Form::label('image', trans("Image").'<span class="text-danger"></span>')) !!}
											...
											@if($model->image != "")	
												<br />
												<a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo SOFTWARE_PARTNER_IMAGE_URL.$model->image; ?>"><img class="img-fluid" width="100%" src="<?php echo SOFTWARE_PARTNER_IMAGE_URL.$model->image; ?>" /></a>
											@endif		
										</div>
										<!--end::Input-->
									</div>
