							...
							<div class="col-xl-12">	
								<div class="row">
									...
									<div class="col-xl-4">
										<!--begin::Input-->
										<div class="form-group">
										    {!! HTML::decode( Form::label('name',trans("Service").'<span class="text-danger"> * </span>')) !!}
											{{ Form::select("service",$services_list,$model->service_id, ['class' => 'form-control form-control-solid form-control-lg '.($errors->has('service') ? 'is-invalid':'')]) }}
												<div class="invalid-feedback"><?php echo $errors->first('service') ; ?></div>		
										</div>
										<!--end::Input-->
									</div>
									...
									<div class="col-xl-4">
										...
										<div class="form-group">
										   {!! HTML::decode( Form::label('image', trans("Image").'<span class="text-danger"></span>')) !!}
											...
											@if($model->image != "")	
												<br />
												<a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo SUB_SERVICES_IMAGE_URL.$model->image; ?>"><img height="50" width="50" src="<?php echo SUB_SERVICES_IMAGE_URL.$model->image; ?>" /></a>
											@endif		
										</div>
										<!--end::Input-->
									</div>
