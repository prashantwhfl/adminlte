        ...
        <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
            ...
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                ...
                <a href="{{WEBSITE_URL}}" class="login-logo pb-xl-20 pb-15">
                    <img src="{{!empty($siteLogo) ? $siteLogo : WEBSITE_IMG_URL.'logo.png'}}" class="max-h-55px" alt="" />
                </a>
                <!--end::Logo-->
                    ...
                    {{ Form::open(['role' => 'form','url' => 'adminpnlx/login',"class"=>"form","id"=>"kt_login_singin_form"]) }}
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                ...
                                <a href="{{ URL::to('adminpnlx/forget_password')}}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">
                                    Forgot Password ?
                                </a>
                            </div>
                        ...
                        <div class="pb-lg-0 pb-5">
                            <a href="javascript:void(0);" id="kt_login_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" style="background-color:#f30000">Login</a>
                        </div>
                        <!--end::Action-->
                    {{ Form::close() }}
                    <!--end::Form-->
